...
$oH->links['ico'] = '<link rel="shortcut icon" href="'.QT_SKIN.'img/qti_icon.ico"/>';
...
if ( QT_MENU_CONTRAST )
{
  ...
  if ( $_SESSION[QT]['contrast'] ) $oH->links['cssContrast'] = '<link id="contrastcss" rel="stylesheet" type="text/css" href="bin/css/qti_contrast.css"/>';
}
