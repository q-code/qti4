...
$oH->scripts[] = 'function ToggleAnonymous(checked){
...
{
echo '<p>Current authority is <span class="bold italic">Internal authority (default)</span>.<br>When module is on-line, change the authority in the page <a href="qti_adm_secu.php" onclick="return qtFormSafe.exit(e0);">'.L('Board_security').'</a>.</p><br>';
}
