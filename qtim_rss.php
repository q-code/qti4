<?php // v4.0 build:20230430 can be app impersonated {qt f|i}
...
foreach($arrSections as $id=>$mSec) {
  $oH->links[] = '<link rel="alternate" type="application/rss+xml" title="'.qtAttr($mSec['title']).'" href="'.$strRssUrl.'/qti_'.$strForm.'_'.$id.'.xml"/>';
}}
