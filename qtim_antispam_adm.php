...
if ( isset($arrIp) )
{
  ...
  echo ' ['.sprintf($L['Antispam']['Banned_ip'],$i).'] <a href="tool_txt.php?exit='.$oH->php.'&file='.$file.'&help=qtim_antispam_ip.txt">'.L('Edit').'...</a>';
  if ( $i ) echo ' | <a href="tool_txt.php?a=delete&exit='.$oH->php.'&file='.$file.'&help=qtim_antispam_ip.txt">'.L('Delete').'</a>';
