...
$oH->selfurl = 'qtim_antispam_adm.php';
...
if ( isset($arrIp) )
{
  ...
  echo ' ['.sprintf($L['Antispam']['Banned_ip'],$i).'] <a href="tool_txt.php?exit='.$oH->selfurl.'&file='.$file.'&help=qtim_antispam_ip.txt">'.L('Edit').'...</a>';
  if ( $i ) echo ' | <a href="tool_txt.php?a=delete&exit='.$oH->selfurl.'&file='.$file.'&help=qtim_antispam_ip.txt">'.L('Delete').'</a>';
