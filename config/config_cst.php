...
const QT_CONTRAST_CSS = true; // allow user to change css mode: contrast/normal
...
const QT_URLCONST = false; // use 'tickets' as url replacement or use FALSE to show url
// When using Q_URLCONST, it's recommanded to add following .htaccess rewriting rule in the application folder:
// RewriteEngine on
// RewriteRule "tickets" "qti_index.php"
