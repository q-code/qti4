...
$L['E_install'] = '<span class="bold">Problem to create the table [%s] into dabase [%s]</span><br><br>Possible causes:<br>&raquo;&nbsp;Table already exists (delete existing table or use prefix).<br>&raquo;&nbsp;The user [%s] is not granted to create table.<br>';
...
$L['Help_2'] = '<span class="bold">Database tables</span>: This will create the tables in your database. If you are making an update, you must skip this step.<br>';
