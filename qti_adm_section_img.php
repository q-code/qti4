<?php // v4.0 build:20230205 allows app impersonation [qt f|e|i]
...
$id = -1;
qtHttp('int:id!'); if ( $id<0 ) die('Missing parameter id...');
...
$oH->links[] = '<link rel="stylesheet" type="text/css" href="bin/css/qt_base.css"/>';
