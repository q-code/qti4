...
if ( !empty($_GET['a']) && $_GET['a']==='view' )
{
  ...
  else
  {
    ...
    echo '<td><a class="small" href="'.APP.'_items.php?q=adv&s='.$s.'&w=*&v='.urlencode($strKey).'" title="'.L('Find_item_tag').'">'.L('Search').'</a></td>'.PHP_EOL;
    echo '</tr>';
    }
    echo '</table>'.PHP_EOL;
    echo '</div>';
...
if ( !empty($_GET['a']) && $_GET['a']==='used' )
{
  ...
  else
  {
    ...
    echo '<td><a class="small" href="'.APP.'_items.php?q=adv&s='.$s.'&w=*&v='.$strValue.'" title="'.L('Find_item_tag').'">'.L('Search').'</a></td>'.PHP_EOL;
    echo '</tr>';
    }
    echo '</table>'.PHP_EOL;
    echo '</div>';
