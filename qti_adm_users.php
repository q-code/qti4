...
// Lettres bar
if ( $intCount>$ipp || $pageGroup!=='all' ) echo htmlLettres(url($oH->selfurl).'?'.qtURI('group|page'), $pageGroup, L('All'), 'lettres', L('Username').' '.L('starting_with').' ', $intCount>300 ? 1 : ($intCount>$ipp*2 ? 2 : 3));
