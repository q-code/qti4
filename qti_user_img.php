...
$id = -1; qtHttp('int:id'); if ( $id<0 ) die('Missing parameter id...');
...
$upload_path = getRepository(QT_DIR_PIC,$id); // The path to where the image will be saved (is checked in qtx_upload_img.php)
...
if ( SUser::id()!==$id ) $warning = '<p>'.getSVG('exclamation-triangle', 'style=color:orange').' '.L('Not_your_account').'</p>';
