...
$strFilename = 'rss/qti_rss2_'.$s.'.xml';
...
fwrite($handle,"<generator>'.APPNAME.' ".substr(VERSION,0,3)."</generator>\n");
...
fwrite($handle,"<image><url>{$_SESSION[QT]['site_url']}/rss/qti_logo.gif</url><title>".$_SESSION[QT]['site_name'].' - '.$oS->title."</title><link>{$_SESSION[QT]['site_url']}/qti_items.php?s=$s</link><width>110</width><height>50</height></image>\n");
fwrite($handle,'<atom:link href="'.$_SESSION[QT]['site_url'].'/rss/qti_rss2_'.$s.'.xml" rel="self" type="application/rss+xml"/>'."\n");
for ($n=0; $n<$i; $n++)
{
fwrite($handle,"<item>\n");
